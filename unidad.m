nR=25;ng=100;h0=10;k=1.25;x=0.54;CVm=0.05;leg=0.75;sr=0.5;Dr=13.6;I0r=0.02;lepR=1.5;spR=1;DpR=25;I0pR=0;
...
while sum(abs(hpR-hpRant))>1e-3;
  ...
  hpR=h0.*vectorUnos-zpR-(0.465.*QpR.^1.75.*DpR.^-4.75.*(lepR+spR));
  ++cont;
end
